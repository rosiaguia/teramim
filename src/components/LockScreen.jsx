      ...
      <section className="container section center">
        <div className="card lock-card fade-up">
          ...
          <div className="lock-support">
            ...
            <span className="login-support-wrap">
              ...
              <a className="btn btn-whatsapp btn-lg" href={SUPPORT_WA} target="_blank" rel="noreferrer">
                Chama aqui
              </a>
            </span>
          </div>
