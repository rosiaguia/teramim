  ...
  return (
    <main>
      ...
      <section className="container section center">
        ...
        <div className="menu-support" style={{ marginTop: 28 }}>
          <p className="support-label">Precisa de ajuda com o app P.A.R.E<sup>®</sup>?</p>
          <div className="support-row">
            ...
            <a className="btn btn-whatsapp btn-lg" href="https://wa.me/5551994034879" target="_blank" rel="noreferrer">
              Chama aqui
            </a>
          </div>
        </div>
